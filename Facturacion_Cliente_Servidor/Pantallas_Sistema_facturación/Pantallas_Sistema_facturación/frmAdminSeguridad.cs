...
namespace Pantallas_Sistema_facturación
{
    public partial class frmAdminSeguridad : Form
    {
        ...
        private Boolean validar() 
        {
            ...
            {   
                MensajeError.SetError(txtPassword, ""); 
            }
        ...
        public bool Guardar()
        {
            ...
            if (validar())
            {
                try
                {
                    ...
                    string sentencia = $"Exec actualizar_Seguridad '{Convert.ToInt32(cboEmpleado.SelectedValue)}','{txtUsuario.Text}','{txtPassword.Text}','{DateTime.Now}','Santiago'";
        ...
        {
            DataTable dt = new DataTable();
            string sentencia = $"select StrUsuario,StrClave from TBLSEGURIDAD where IdEmpleado = {cboEmpleado.SelectedValue}";
